...
function openAndSetUpBookingModal(nameHotel){
    ...
    NoDiscount.innerHTML = (discount(nameHotel) == 0)?'': '<br><i>The discount is not valid for the chosen dates.</i>';
