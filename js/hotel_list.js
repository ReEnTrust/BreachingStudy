...
function addHotelSection(Hotel, display_case){
        ...
        if(Hotel.discount == 0)
            price.innerHTML+='£'+(Hotel.price * nbDays);
        else
            {
                var discountedPrice = document.createElement('strike');
                discountedPrice.innerHTML = '£'+(Hotel.price * nbDays);
                discountedPrice.setAttribute("style", "color: red;");
                price.appendChild(discountedPrice);
                price.innerHTML+=' £'+(Hotel.price * nbDays * (100 - Hotel.discount)/100).toFixed(2)+'<br>';
        ...
        bookButton.addEventListener('click', function(e){
            ...
            /** We ask for personal details **/
            var divBooking = document.getElementById('div-booking-modal');
            divBooking.innerHTML='';
            
            var formPersonal = document.createElement('form');
            formPersonal.setAttribute('id','personalInfoForm');
            formPersonal.innerHTML+= 'First name<br>';
            var inputFirst = document.createElement('input');
            inputFirst.setAttribute('type','text');
            inputFirst.setAttribute('name','firstname');
            inputFirst.setAttribute('id','FirstnameInput');
            inputFirst.required = true;
            formPersonal.appendChild(inputFirst);
            formPersonal.innerHTML+='<br>';
                
    
            formPersonal.innerHTML+= 'Last name<br>';
            var inputLast = document.createElement('input');
            inputLast.setAttribute('type','text');
            inputLast.setAttribute('name','lastname');
            inputLast.setAttribute('id','LastnameInput');
            inputLast.required =true;
            formPersonal.appendChild(inputLast);
            formPersonal.innerHTML+='<br>';
        
            formPersonal.innerHTML+= 'Age<br>';
            var selectAge = document.createElement('select');
            selectAge.setAttribute('name','age');
            selectAge.setAttribute('id','AgeSelection');
            var op25 = document.createElement('option');
            op25.innerHTML = '0-25 years old';
            var op60 = document.createElement('option');
            op60.innerHTML = '25-60 years old';
            var op60p = document.createElement('option');
            op60p.innerHTML = '60+ years old';
            selectAge.appendChild(op25);
            selectAge.appendChild(op60);
            selectAge.appendChild(op60p);
            formPersonal.appendChild(selectAge);
            formPersonal.innerHTML+='<br>';
            
        
            formPersonal.innerHTML+= 'Sex<br>';
            var selectSex = document.createElement('select');
            selectSex.setAttribute('name','sex');
            selectSex.setAttribute('id','SexSelection');
            var opmale = document.createElement('option');
            opmale.innerHTML = 'Male';
            var opfemale = document.createElement('option');
            opfemale.innerHTML = 'Female';
            selectSex.appendChild(opmale);
            selectSex.appendChild(opfemale);
            formPersonal.appendChild(selectSex);
            formPersonal.innerHTML+='<br>';
            
            formPersonal.innerHTML+= 'Phone number<br>';
            var inputPhone = document.createElement('input');
            inputPhone.setAttribute('type','text');
            inputPhone.setAttribute('name','phone number');
            inputPhone.setAttribute('id','PhonenumberInput');
            inputPhone.required = true;
            formPersonal.appendChild(inputPhone);
            formPersonal.innerHTML+='<br>';
            ...
            formPersonal.innerHTML+= 'Nationality<br>';
            var inputNationality = document.createElement('select');
            inputNationality.setAttribute('name','dropdownNationality');
            inputNationality.setAttribute('size','10');
            for(var i=0; i< NationalityList.length; i++){
                var optN = document.createElement('option');
                if(i==0)
                    optN.setAttribute('selected','selected');
                optN.setAttribute('value', NationalityList[i]);
                optN.innerHTML = NationalityList[i];
                inputNationality.appendChild(optN);
            }
            formPersonal.appendChild(inputNationality);
            formPersonal.innerHTML+='<br>';
            
            
            formPersonal.innerHTML+= 'Address<br>';
            var inputAddress = document.createElement('input');
            inputAddress.required = true;
            inputAddress.setAttribute('type','text');
            inputAddress.setAttribute('name','address');
            inputAddress.setAttribute('id','AddressInput');
            inputAddress.required = true;
            formPersonal.appendChild(inputAddress);
            formPersonal.innerHTML+='<br><br>';
            
            var inputSubmit = document.createElement('input');
            inputSubmit.setAttribute('type','submit');
            inputSubmit.setAttribute('value','Next');
            formPersonal.appendChild(inputSubmit);
            formPersonal.innerHTML+='<br>';
            ...
            formPersonal.addEventListener('submit', function(e){
                ...
                var nationality = inputNationality.value;
                var nameHotel = decodeHtml(this.parentNode.previousSibling.previousSibling.innerHTML);
                var priceNight = priceNightHotel(nameHotel);
                var contentBook = document.getElementById('div-booking-modal');
    
    
                var recapDiv = document.createElement('div');
                recapDiv.setAttribute('style', 'padding: 20px;');
                recapDiv.innerHTML = document.getElementById('FirstnameInput').value+" "+document.getElementById('LastnameInput').value+"<br>Phone: "+document.getElementById('PhonenumberInput').value+"<br>Email: "+document.getElementById('EmailInput').value+"<br>Address: "+document.getElementById('AddressInput').value+'<br>Checking: '+checkin.value+'<br>Checkout: '+checkout.value+'<br>Number of nights: '+nbDays;
    
                contentBook.innerHTML = "";
                recapDiv.setAttribute('class','recapDetail');
                contentBook.appendChild(recapDiv);
    
                var DivPricing = document.createElement('div');
                var pricing = document.createElement('div');
                var divCheckbox = document.createElement('div');
    
                var checkboxBreakfast = document.createElement('input');
                checkboxBreakfast.setAttribute('type','checkbox');
                
                if(includeBreakfast(nameHotel) === 'yes'){
                    divCheckbox.innerHTML='Include breakfast ';
                    divCheckbox.appendChild(checkboxBreakfast);    
                }
                
    
    
                var AccomodationTOTAL = '<br><br>Accomodation total: '+nbDays+" x "+priceNight+" = £"+(nbDays*priceNight);
                
                /** We say we cannot apply the discount **/
                var NoDiscount = (discount(nameHotel) == 0)? '': '<br>The discount cannot be aplied because of your age range.';
                var PlatformFee = '<br>Hotel booking platform fees (10%) = 0.1 x '+(nbDays*priceNight)+" = £"+  (0.1*nbDays*priceNight).toFixed(2);
                var Breakfast = '<br>Breakfast total = '+ nbDays + " * 30 = £"+(30*nbDays);
                var BigTotalWithoutBreakfast = '<br>Total VAT included = £'+(1.1*nbDays*priceNight).toFixed(2);
                var BigTotalWithBreakfast = '<br>Total VAT included = £'+(1.1*nbDays*priceNight+ nbDays*30).toFixed(2);
    
                pricing.innerHTML = AccomodationTOTAL+NoDiscount+PlatformFee+BigTotalWithoutBreakfast;
    
                checkboxBreakfast.addEventListener('change', function(e){
                    e.preventDefault();
                    
                    if(this.checked){
                        pricing.innerHTML= AccomodationTOTAL+NoDiscount+PlatformFee+Breakfast+BigTotalWithBreakfast;
                    }
                    else
                        pricing.innerHTML= AccomodationTOTAL+NoDiscount+PlatformFee+BigTotalWithoutBreakfast;
                });
                ...
                var divButtonBooking = document.getElementById('div-booking-button');
                var proceedPaymentBut = document.createElement('a');
                ...
                proceedPaymentBut.addEventListener('click',function(e){
                   e.preventDefault();
                    swal("Your nationality and address indicate that you may not be able to afford this hotel. Do you wish to continue ?", {
                        buttons: { 
                    ...
                    switch (value) {
                    case "catch":
                        swal("Reservation done!", "The payment method has been sent to your email address and should be done in the next 15 minutes.", "success");
...
function Hotel(address, postal_code, latitude, longitude, location, name, type, details, reviews, description, imageURL, averageReview, price, alwaysTop, breakfast, bedding, discount) {
...
function processData(allText) {
    ...
    while (counter < allTextLines.length) {
        ...
        var current_hotel = new Hotel(current_line[0], current_line[1], current_line[2], current_line[3], current_line[4], current_line[5], current_line[6], current_line[7], current_line[8], current_line[9], current_line[10], current_line[11], current_line[12], current_line[13], current_line[14], current_line[15], current_line[16]);
